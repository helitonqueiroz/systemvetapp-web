...
```
mkdir ~/systemvetrepo ~/systemvetapp
```
...
cd ~/systemvetapp
git init
git remote add systemvetrepo ~/systemvetrepo
git add .
git commit -m 'Initial'
git push systemvetrepo main -u # erro
```

No seu computador local

```
git remote add systemvetrepo usuario@IP_SERVIDOR:~/systemvetrepo
git push systemvetrepo main
```
...
```
nano ~/systemvetapp/project/local_settings.py
```
